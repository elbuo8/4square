    ...
    module.exports = function (client_id, client_secret) {
        ...
        return {
            ...
            getVenue:function (params, callback) {
                ...
                urlString = params.venue_id ? [urlString,params.venue_id,'?'].join('') : urlString;
                urlString = client_id ? [urlString,['client_id',client_id].join('=')].join('') : urlString;
                urlString = client_secret ? [urlString,['client_secret',client_secret].join('=')].join('&') : urlString;
                urlString = [urlString,['v',date].join('=')].join('&')
            ...
            getCategories:function (params, callback) {
                var urlString;
                urlString = "https://api.foursquare.com/v2/venues/categories";
                if (client_id != null) {
                    urlString += "?client_id=" + client_id;
                }
                if (client_secret != null) {
